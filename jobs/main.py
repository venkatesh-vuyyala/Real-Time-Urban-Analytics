...
def simulate_journey(producer,device_id):
    while True:
        ...
        emergency_incident_data = generate_emergency_incident_data(vehicle_data['timestamp'], device_id, vehicle_data['location'])
...
if __name__ == "__main__":
    ...
    try:
        simulate_journey(producer,'Vehicle-venkatesh-123')
